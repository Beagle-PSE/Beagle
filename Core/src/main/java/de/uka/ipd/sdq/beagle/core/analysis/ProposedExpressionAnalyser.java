 ...
 * interface.
 *
 * <p>The proposed expression analysers added to the extension point need a public zero
 * argument constructor for the instantiation.
 *
...
public interface ProposedExpressionAnalyser {
	 ...
	 * @param blackboard The current blackboard.
	 */
	void contribute(ProposedExpressionAnalyserBlackboardView blackboard);
}
