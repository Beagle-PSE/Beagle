 ...
 * @author Michael Vogt
 */
public class MeasurementResultAnalyserBlackboardView implements 
      EvaluableExpressionFitnessFunctionBlackboardView {

  private Blackboard blackboard;
  
  private MeasurementResultAnalyserBlackboardView(Blackboard blackboard) {
  ...
  public void addToBeMeasuredRdias(final Collection<ResourceDemandingInternalAction> rdias) {
    blackboard.addToBeMeasuredRdias(rdias);
  }
  ...
  public void addToBeMeasuredSeffBranches(final Collection<SeffBranch> branches) {
    blackboard.addToBeMeasuredSeffBranches(branches);
  }
  ...
  public void addToBeMeasuredSeffLoops(final Collection<SeffLoop> loops) {
    blackboard.addToBeMeasuredSeffLoops(loops);
  }
  ...
  public void addToBeMeasuredExternalCallParameters(
    ...
    blackboard.addToBeMeasuredExternalCallParameters(parameters);
  }
  ...
  /**
   * Delegates to
   * {@link de.uka.ipd.sdq.beagle.core.Blackboard#addProposedExpressionFor(MeasurableSeffElement,
   *  EvaluableExpression)}
   * .
   *
  ...
  public void addProposedExpressionFor(final MeasurableSeffElement element,
    ...
    blackboard.addProposedExpressionFor(element, expression);
  }
