...
public class SeffLoopTest {
	...
	public void testEquals() {
		...
		final File file3 =
			new File(SeffLoopTest.class.getResource("de/uka/ipd/sdq/beale/core/TestFile.java").getPath());
	...
	public void testGetLoopBody() {
		final File file = new File(SeffLoopTest.class.getResource("/test.txt").getPath());
		final int startCodeLine = 4;
		final int endCodeLine = 15;
		final File file2 =
